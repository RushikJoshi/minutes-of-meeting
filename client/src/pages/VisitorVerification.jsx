    ...
    <div className="min-h-screen bg-slate-50 px-4 py-12 flex items-center justify-center">
      <div className="max-w-md w-full bg-white rounded-[40px] shadow-2xl overflow-hidden border border-slate-100">
        <div className="bg-slate-900 p-8 text-center">
          ...
          <div className="mt-2 inline-flex items-center gap-2 px-3 py-1 bg-emerald-500/10 text-emerald-400 rounded-full text-[10px] font-black uppercase tracking-widest border border-emerald-500/20">
            {visitor.status}
          </div>
        </div>
        ...
        <div className="p-8 space-y-6">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
              <p className="text-[10px] font-black text-slate-400 uppercase mb-1">Purpose</p>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 text-slate-600 bg-slate-50 p-3 rounded-xl border border-slate-100">
              ...
              <div className="flex flex-col">
                <span className="text-[10px] font-black text-slate-400 uppercase">Mobile</span>
            ...
            <div className="flex items-center gap-3 text-slate-600 bg-slate-50 p-3 rounded-xl border border-slate-100">
              ...
              <div className="flex flex-col">
                <span className="text-[10px] font-black text-slate-400 uppercase">Identity Document</span>
            ...
            <div className="flex items-center gap-3 text-slate-600 bg-blue-50 p-3 rounded-xl border border-blue-100">
              ...
              <div className="flex flex-col">
                <span className="text-[10px] font-black text-blue-400 uppercase">Meeting Schedule</span>
          ...
          {visitor.status === "APPROVED" && (
            <button
              ...
              disabled={verifying}
              className="w-full py-5 bg-emerald-600 text-white rounded-[24px] font-black text-lg hover:bg-emerald-700 transition-all shadow-xl shadow-emerald-100 flex items-center justify-center gap-3 active:scale-95"
            >
          ...
          {visitor.status === "CHECKED_IN" && (
            <div className="py-5 bg-blue-50 text-blue-700 rounded-[24px] font-black text-center flex items-center justify-center gap-3 border-2 border-blue-100">
          ...
          {visitor.status === "PENDING" && (
            <div className="p-6 bg-amber-50 rounded-[24px] text-center border-2 border-dashed border-amber-200">
              ...
              <p className="text-amber-800 font-black uppercase text-sm">Waiting for Host Approval</p>
